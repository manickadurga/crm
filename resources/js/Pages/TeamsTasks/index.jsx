...
function TeamsTasks() {
  ...
  // useEffect(() => {
  //   fetchTeamtask(currentPage, location.pathname);
  // }, [currentPage, location.pathname]);

  // const fetchTeamtask = (page, pathname) => {
  //   setLoading(true);
  //   getDataFunction(pathname.substring(1), page).then((res) => {
  //     console.log("res", res);
  //     const tasks = res[pathname.substring(1)];
  //     setDataSource(tasks);
  //     setTotalRecords(res.pagination.total);

  //     // Generate columns dynamically
  //     const firstRowKeys = Object.keys(tasks[0]);
  //     const generatedColumns = firstRowKeys.map((key) => ({
  //       title: (
  //         <div>
  //           <div style={{ borderBottom: '1px solid #eee', marginBottom: 8, paddingBottom: 4, textAlign: 'center' }}>
  ...
  //   if (key === 'tags' || key === 'invoice_status' || key === 'paid') {
  //     const options = selectOptions.find(option => option.dataIndex === key)?.options || [];
  //     return (
  //       <Select
  ...
  //       </Select>
  //     );
  //   } else if (key === 'createdDate' || key === 'duedate') {
  //     return (
  //       <DatePicker
  //         style={{ width: '100%' }}
  ...
  // const renderCellContent = (text, key) => {
  //   if (text) {
  //     if (key === 'tags') {
  //       return (
  //         <>
